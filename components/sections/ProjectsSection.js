          ...
          {projects.map((project) => {
            return (
              <div key={project.id} className="relative group">
                ...
                <Card className="relative bg-slate-300 border border-gray-400 dark:border-gray-700 dark:bg-gray-900/80 backdrop-blur-sm rounded-xl group-hover:border-blue-500/50 transition-all duration-300 group-hover:scale-105">
                  <CardHeader>
