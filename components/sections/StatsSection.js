    ...
    <div id="stats" className="border-dotted py-16 border-b border-gray-600">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="dark:text-gray-400 text-gray-600 text-lg">Building, solving, and shipping consistently</p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="relative bg-slate-300 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-gray-700/50 group-hover:border-gray-600 transition-all duration-300">
                  <div className="text-4xl mb-3 group-hover:scale-110 transition-transform duration-300">
                    {stat.icon}
                  </div>
                  <div className="text-3xl md:text-4xl font-extrabold bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 dark:from-blue-300 dark:via-purple-300 dark:to-pink-300 bg-clip-text text-transparent mb-2">
                    {stat.number}
                  </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block">
            <div className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-full border border-gray-700/50">
              ...
              <span className="dark:text-gray-300 text-gray-700 font-medium">Available for new opportunities</span>
            </div>
          </div>
        </div>
      </div>
